...
wd = Dir.pwd
Dir.chdir "../../../Core/Foundation/library/includes"
inc = Dir.pwd
Dir.chdir "#{inc}/../../../../Core/Foundation/library/boost"
boost = Dir.pwd
Dir.chdir "#{inc}/../../../../Core/DSP/library/includes"
dsp = Dir.pwd
Dir.chdir "#{inc}/../../../../Core/Graph/library/includes"
graph = Dir.pwd
Dir.chdir "#{inc}/../../../../Core/AudioGraph/library/includes"
audiograph = Dir.pwd
Dir.chdir wd
